...
class DiffNet(nn.Module):
    ...
    def __init__(
        ...
        self.evolution = FeatureEvolutionSubnetwork(
            in_channels=6, # Enhanced image (3) + Depth (3)
            encoding_channels=evolution_cfg['encoding_channels'],
            decoding_channels=evolution_cfg['decoding_channels'],
            out_channels=3,
        )
        
        # 4. Lightweight Detection Subnetwork
        self.detection_subnetwork = LightweightDetectionSubnetwork(
            num_classes=num_classes,
            in_channels=evolution_cfg['encoding_channels'],
        )
